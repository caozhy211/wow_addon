...
target.tags.name:SetPoint("TopLeft", target.health, 3, -3)
...
player.tags.race:SetPoint("TopLeft", player.health, 3, -3)
...
player.tags.percentHealth:SetPoint("BottomRight", player.health, -3, 3)
player.tags.health = player.tags:CreateFontString()
player.tags.health:SetFont(GameFontNormal:GetFont(), 11, "Outline")
player.tags.health:SetPoint("BottomLeft", player.health, 3, 3)
...
focus.tags.percentHealth:SetPoint("Left", focus.health, 3, 0)
focus.tags.absorb = focus.tags:CreateFontString()
focus.tags.absorb:SetFont(GameFontNormal:GetFont(), 11, "Outline")
focus.tags.absorb:SetPoint("Right", focus.health, -3, 0)
...
targetTarget.tags.percentHealth:SetPoint("Left", targetTarget.health, 3, 0)
...
targetTarget.tags.absorb:SetPoint("Right", targetTarget.health, -3, 0)
...
targetTarget.tags.percentPower:SetPoint("Left", targetTarget.power, 3, 0)
...
targetTarget.tags.name:SetPoint("Right", targetTarget.power, -3, 0)
...
for i = 1, 5 do
    ...
    bosses[i].tags.percentHealth:SetPoint("Left", bosses[i].health, 3, 0)
    bosses[i].tags.absorb = bosses[i].tags:CreateFontString()
    bosses[i].tags.absorb:SetFont(GameFontNormal:GetFont(), 11, "Outline")
    bosses[i].tags.absorb:SetPoint("Right", bosses[i].health, -3, 0)
    ...
    bosses[i].tags.percentPower:SetPoint("Left", bosses[i].power, 3, 0)
    bosses[i].tags.name = bosses[i].tags:CreateFontString()
    bosses[i].tags.name:SetFont(GameFontNormal:GetFont(), 11, "Outline")
    bosses[i].tags.name:SetPoint("Right", bosses[i].power, -3, 0)
