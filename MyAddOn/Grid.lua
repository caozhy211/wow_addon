local lineSize = 1
local squareSize = 30
local grid = CreateFrame("Frame", "MyGrid", UIParent)
local numHoriz, numVertical

grid:Hide()
grid:SetAllPoints()
numHoriz = floor(grid:GetHeight() / squareSize + 0.5)
...
for i = 0, numHoriz do
    ...
    line:SetColorTexture(i == numHoriz / 2 and 1 or 0, 0, 0, 0.5)
end
